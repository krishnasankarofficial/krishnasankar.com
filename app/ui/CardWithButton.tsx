...
const CardWithButton = ({
  ...
  return (
    <div className="relative w-full h-full bg-white bg-opacity-80 rounded-3xl shadow-lg p-6 overflow-hidden cursor-pointer flex flex-col items-start justify-start hover:-translate-y-2 hover:scale-105 duration-300 group">
      {/* Card Content */}
