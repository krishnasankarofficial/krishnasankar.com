            ...
            {faqInView && (
                <>
                    <motion.h2 
                        ...
                        className="mb-6 text-3xl md:text-6xl font-extrabold font-raleway bg-gradient-to-b from-gray-700 to-black bg-clip-text text-transparent py-4"
                        >
                    ...
                    {faqs.map((faq, index) => (
                        <motion.div
                            ...
                            key={index} 
                            className="relative w-2/3 flex flex-col items-start justify-between gap-4 py-4 px-6 bg-white bg-opacity-20 rounded-3xl cursor-pointer duration-300"
                            ...
                            <div className="flex flex-col items-start gap-4">
                                <p className="text-2xl font-bold font-raleway">{faq.question}</p>
                            </div>
                            {faq.active && (
